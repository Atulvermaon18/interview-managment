  ...
  const menuGroups = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Skill Analysis', path: '/skill-analysis', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' },
        { name: 'Interview Stages', path: '/interview-stages', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01' },
      ]
    },
    {
      title: 'Management',
      items: [
        { name: 'Assessment', path: '/assessment', icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z' },
    ...
    <div className="h-full bg-white border-r border-gray-200 flex flex-col">
      ...
      <div className="flex items-center justify-center h-16 px-4 border-b border-gray-200">
        <Link href="/home" className="flex items-center space-x-2">
          ...
          <span className="text-md font-bold text-blue-600">Interview Management</span>
        </Link>
      </div>
                  ...
                  >
                    <svg
                      className={`mr-3 h-5 w-5 ${
                        pathname === item.path ? 'text-blue-600' : 'text-gray-400 group-hover:text-gray-500'
                      }`}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
